...
export const PictureChoice: FC<BlockProps> = ({ field, ...restProps }) => {
  ...
  return (
    <Block
      className={clsx('neptunysform-picture-choice', {
        'neptunysform-picture-choice-compare': isComparisonLayout
      })}
      field={field}
      {...restProps}
    >
      ...
      >
        ...
        >
          <ChoiceRadioGroup
            className={clsx({
              'neptunysform-picture-choice-list-compare': isComparisonLayout
            })}
            options={options}
