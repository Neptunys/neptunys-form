import type { DateRangeValue } from '@neptunysform-inc/shared-types-enums'
...
export const DateRangeInput: FC<DateRangeInputProps> = ({
  ...
  return (
    <div
      className={clsx('neptunysform-range-root', {
        'neptunysform-range-width-time': allowTime
      })}
    >
      <DateInput
        value={value?.start}
        ...
        onError={onError}
      />
      <div className="neptunysform-range-divider">{t('to')}</div>
      <DateInput
        value={value?.end}
        format={format}
        allowTime={allowTime}
