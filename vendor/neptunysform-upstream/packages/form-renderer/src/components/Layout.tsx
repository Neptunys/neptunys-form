import { FieldLayoutAlignEnum, type Layout as FormLayout } from '@neptunysform-inc/shared-types-enums'
import type { CSSProperties, FC } from 'react'
import { memo } from 'react'

import { isRenderableImageSource } from '../utils'
import { deepEqual, helper } from '@neptunysform-inc/utils'
...
const LayoutComponent: FC<FormLayout> = props => {
  ...
  return (
    <div className={`neptunysform-layout neptunysform-layout-${props!.align}`} style={style}>
      <img
        src={props!.mediaUrl}
