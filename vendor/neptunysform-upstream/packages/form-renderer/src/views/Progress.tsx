...
const CircularProgressbar: FC<CircularProgressbarProps> = ({
  ...
  return (
    <svg className="neptunysform-circular-progressbar" viewBox={`0 0 ${radius * 2} ${radius * 2}`}>
      <circle
        className="neptunysform-circular-circle"
        fill="none"
        cx={radius}
        cy={radius}
      ...
      />
      <path
        className="neptunysform-circular-path"
        fill="none"
        strokeLinecap="round"
...
export const Progress: FC = () => {
  ...
  return (
    <div className="neptunysform-progress">
...
export const TopProgressBar: FC = () => {
  ...
  return (
    <div
      className="neptunysform-progress-top-bar"
      aria-label={t('{{number}}% answered', { number: state.percentage })}
    >
      <div className="neptunysform-progress-top-bar-track">
        <div
          className="neptunysform-progress-top-bar-fill"
