...
const FormItemLink: FC<FormItemLinkProps> = ({
  ...
  function handleSuspend() {
    alert({
      ...
      onConfirm() {
        window.location.href = 'https://neptunysform.net/f/E4MKK2hx'
      }
    })
  }
...
const FormItem: FC<FormItemProps> = ({ form, isInTrash, onChange }) => {
  ...
  return (
    <FormItemLink
      className="group flex items-center justify-between gap-6 px-6 py-6 hover:bg-accent-light has-[[data-state=open]]:bg-accent-light"
