import { insertWebFont } from '@neptunysform-inc/form-renderer'
import { FieldKindEnum } from '@neptunysform-inc/shared-types-enums'
...
export default function BuilderCompose() {
  ...
  const isMobile = window.neptunysform?.device?.mobile ?? false

  return (
    <div
      className={cn('compose', {
        'compose-mobile': isMobile
      })}
    >
