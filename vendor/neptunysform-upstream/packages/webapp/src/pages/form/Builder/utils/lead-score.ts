...
export const LEAD_SCORE_LABEL_CLASSNAME =
  'min-w-10 text-[11px] font-medium uppercase tracking-[0.08em] text-[color:var(--neptunysform-answer-color)] opacity-50'

export const LEAD_SCORE_SELECT_CLASSNAME =
  'w-32 border-[color:var(--neptunysform-answer-color)] text-[color:var(--neptunysform-answer-color)] opacity-50 [&_[data-slot=icon]_svg]:text-[color:var(--neptunysform-answer-color)] [&_[data-slot=placeholder]]:text-[color:var(--neptunysform-answer-color)] [&_[data-slot=value]]:text-[color:var(--neptunysform-answer-color)]'
