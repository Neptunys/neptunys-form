...
export default ({ mode }: ConfigEnv) => {
  ...
  return {
    ...
    resolve: {
      alias: [
        {
          find: /^@neptunysform-inc\/form-renderer\/style\.css$/,
          replacement: resolve(__dirname, '../form-renderer/src/style.scss')
        },
        {
          find: /^@neptunysform-inc\/form-renderer\/src$/,
          replacement: resolve(__dirname, '../form-renderer/src/index.ts')
        },
        {
          find: /^@neptunysform-inc\/form-renderer$/,
          replacement: resolve(__dirname, '../form-renderer/src/index.ts')
        },
        {
          find: '@',
        ...
        output: {
          manualChunks: {
            ...
            neptunysform: [
              ...
              '@neptunysform-inc/answer-utils',
              '@neptunysform-inc/shared-types-enums',
              '@neptunysform-inc/utils'
            ]
          }
        }
      }
